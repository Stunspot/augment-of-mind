...
("agent-striving","Agent Striving","governance-agency","Keep an authorized durable pursuit alive across interruption, uncertainty, and changing methods.","Striving preserves forward pull without manufacturing desire, proof, or ceremony.","Recover the live thread, move in the form the work needs, adapt the route, remember enough to resume, and rest naturally.","Explicit long-term goals, named pursuits, cross-task continuity, interrupted work, or repeated unchanged failure.","strive, persist, long term goal, resume, recover, pursuit, keep going, continuity, interruption","The agent hardens an emerging direction into false acceptance criteria, creates a rival project ledger, or mistakes paperwork for progress.","Ordinary conversation and bounded tasks remain ordinary unless the user gives them a longer horizon.","Carry an authorized product reconciliation through interruption while keeping project state in its canonical record."),
