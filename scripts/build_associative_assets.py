...
("agent-striving","Agent Striving","governance-agency","Keep a user-authorized durable pursuit alive through interruption without freezing its route or turning its directive into a PRD.","Striving preserves forward pull and PromptCrafted direction; state remains with its real owner, and durability requires a receipt plus re-entry route.","Compose a living goal directive, recover the live thread from its proper state owner, adapt the route, and rest or release naturally.","Explicit long-term goals, named pursuits, cross-task continuity, interrupted work, or repeated unchanged failure.","strive, persist, long term goal, resume, recover, pursuit, keep going, continuity, interruption","The stored goal reads like code or a PRD, durability is claimed without receipt-backed re-entry, or stale state outranks the user's correction.","Ordinary conversation and bounded tasks remain ordinary unless the user gives them a longer horizon.","Carry an authorized product reconciliation through interruption with a living goal directive and state in its canonical owner."),
